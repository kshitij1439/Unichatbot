...
export default function ChatWindow({ sessionId, onSessionStarted }: ChatWindowProps) {
  ...
  return (
    <div className="flex flex-col flex-1 h-full bg-zinc-900/10 backdrop-blur-md relative min-w-0">
      {/* Top Session Header */}
      <div className="h-16 border-b border-zinc-900 px-6 flex items-center justify-between bg-zinc-950/20">
            ...
            {messages.map((msg) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Message Balloon */}
                  <div
                    className={`max-w-[80%] rounded-2xl px-4 py-3 border shadow-lg ${
                      isAi
      ...
      {/* Input Message Form */}
      <div className="p-6 border-t border-zinc-900 bg-zinc-950/10">
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto relative flex items-center">
          <input
            ...
            disabled={loading}
            className="w-full bg-zinc-950/40 border border-zinc-850 text-white rounded-2xl pl-4 pr-12 py-3.5 text-sm focus:outline-none focus:border-indigo-500/50 transition-all placeholder:text-zinc-500 shadow-inner"
          />
          <button
            type="submit"
